...
/*   Updated: 2024/03/08 10:12:12 by abel-hid         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Channel::setTopicRestriction(bool isTopicRestriction) 
{ 
...
bool Channel::isTopicRestriction() 
{ 
...
void Channel::set_creater(bool creater)
{
    this->creater = creater;
}
bool Channel::get_creater()
{
    return (creater);
}
